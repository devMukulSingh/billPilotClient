...
const distributorApiSlice = splitApi.injectEndpoints({
    endpoints: (build) => ({
        ...
        getAllDistributors: build.query<TApiResponse<TDistributor[]>, { userId: string | null | undefined }>({
            query: (arg) => ({
...
export const { useDeleteDistributorMutation, useGetAllDistributorsQuery, useGetDistributorsQuery, useGetSearchedDistributorsQuery, usePostDistributorMutation, usePutDistributorMutation } = distributorApiSlice;